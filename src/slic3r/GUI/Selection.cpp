...
static const std::array<float, 4> UNIFORM_SCALE_COLOR = { 0.875f, 0.749f, 0.098f, 1.0f }; // categorical 1
...
{
    float color[3] = { 0.980f, 0.980f, 0.980f }; // 98% white
...
void Selection::render_sidebar_layers_hints(const std::string& sidebar_field) const
{
    ...
    if ((camera_on_top && type == 1) || (!camera_on_top && type == 2))
        ::glColor4f(0.910f, 0.529f, 0.102f, 1.0f); // categorical 2
    else
        ::glColor4f(0.753f, 0.753f, 0.753f, 0.502f); // 75% white 50% alpha
