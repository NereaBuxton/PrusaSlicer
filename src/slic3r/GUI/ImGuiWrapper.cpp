...
const ImVec4 ImGuiWrapper::COL_GREY_LIGHT        = { 0.502f, 0.502f, 0.502f, 1.0f }; // 50% shade
...
bool ImGuiWrapper::slider_float(const char* label, float* v, float v_min, float v_max, const char* format/* = "%.3f"*/, float power/* = 1.0f*/, bool clamp /*= true*/, const wxString& tooltip /*= ""*/, bool show_edit_btn /*= true*/)
{
    ...
    if (show_edit_btn) {
        ...
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered, { 0.502f, 0.502f, 0.502f, 1.0f }); // 50% shade
        ImGui::PushStyleColor(ImGuiCol_ButtonActive, { 0.502f, 0.502f, 0.502f, 1.0f }); // 50% shade
