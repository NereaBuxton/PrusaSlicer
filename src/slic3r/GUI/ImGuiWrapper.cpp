...
const ImVec4 ImGuiWrapper::COL_GREY_DARK         = { 0.251f, 0.251f, 0.251f, 1.0f }; // 25.1% mono shade colortag
const ImVec4 ImGuiWrapper::COL_GREY_LIGHT        = { 0.502f, 0.502f, 0.502f, 1.0f }; // 50.2% mono tone colortag
const ImVec4 ImGuiWrapper::COL_ORANGE_DARK       = { 0.796f, 0.435f, 0.098f, 1.0f }; // categorical 10 colortag
const ImVec4 ImGuiWrapper::COL_ORANGE_LIGHT      = { 0.910f, 0.529f, 0.102f, 1.0f }; // categorical 3 colortag
const ImVec4 ImGuiWrapper::COL_WINDOW_BACKGROUND = { 0.098f, 0.098f, 0.098f, 0.8f }; // 9.8% near-black, 80% alpha colortag
...
bool ImGuiWrapper::slider_float(const char* label, float* v, float v_min, float v_max, const char* format/* = "%.3f"*/, float power/* = 1.0f*/, bool clamp /*= true*/, const wxString& tooltip /*= ""*/, bool show_edit_btn /*= true*/)
{
    ...
    if (show_edit_btn) {
        ...
        ImGui::PushStyleColor(ImGuiCol_Button, { 0.251f, 0.251f, 0.251f, 0.0f }); // 25.1% mono shade, 0% alpha colortag
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered, { 0.502f, 0.502f, 0.502f, 1.0f }); // 50.2% mono tone colortag
        ImGui::PushStyleColor(ImGuiCol_ButtonActive, { 0.502f, 0.502f, 0.502f, 1.0f }); // 50.2% mono tone colortag
...
std::vector<unsigned char> ImGuiWrapper::load_svg(const std::string& bitmap_name, unsigned target_width, unsigned target_height)
{
    ...
    NSVGimage* image = BitmapCache::nsvgParseFromFileWithReplace(Slic3r::var(bitmap_name + ".svg").c_str(), "px", 96.0f, { { "\"#808080\"", "\"#FAFAFA\"" } }); // 98% near-white colortag
    if (image == nullptr)
        return empty_vector;
