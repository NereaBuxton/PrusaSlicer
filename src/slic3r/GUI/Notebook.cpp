...
void ButtonsListCtrl::OnPaint(wxPaintEvent&)
{
    ...
    // Draw BG same colour as lightmode grey line on menubar, to hide it
    // Make it same colour as objectlist BG, use this to mimic "tab background"
    ...
    // Draw orange line on top in dark mode
