...
void GCodeViewer::SequentialRangeCap::reset() {
    ...
    ibo = 0;
    vbo = 0;
    color = { 0.098f, 0.098f, 0.098f, 1.0f }; // 9.8% near-black colortag
}

void GCodeViewer::SequentialView::Marker::init()
{
    m_model.init_from(stilized_arrow(16, 2.0f, 4.0f, 1.0f, 8.0f));
    m_model.set_color(-1, { 0.980f, 0.980f, 0.980f, 0.502f }); // 98% near-white, 50.2% alpha colortag
}
...
void GCodeViewer::SequentialView::GCodeWindow::render(float top, float bottom, uint64_t curr_line_id) const
{
    ...
    static const ImVec4 COMMAND_COLOR = { 0.875f, 0.749f, 0.098f, 1.0f }; // categorical 9 colortag
    static const ImVec4 PARAMETERS_COLOR = { 0.980f, 0.980f, 0.980f, 1.0f }; // 98% near-white colortag
    static const ImVec4 COMMENT_COLOR = { 0.753f, 0.753f, 0.753f, 1.0f }; // 75.3% mono tint colortag
...
const std::vector<GCodeViewer::Color> GCodeViewer::Extrusion_Role_Colors {{ // categorical colors: https://spectrum.adobe.com/page/color-for-data-visualization/
    { 0.502f, 0.502f, 0.502f, 1.0f },   // erNone: 50.2% mono tone colortag
    { 0.875f, 0.749f, 0.098f, 1.0f },   // erPerimeter: categorical 9 colortag
    { 0.910f, 0.529f, 0.102f, 1.0f },   // erExternalPerimeter: categorical 3 colortag
    { 0.153f, 0.502f, 0.922f, 1.0f },   // erOverhangPerimeter: categorical 7 colortag
    { 0.855f, 0.204f, 0.565f, 1.0f },   // erInternalInfill: categorical 4 colortag
    { 0.435f, 0.220f, 0.694f, 1.0f },   // erSolidInfill: categorical 8 colortag
    { 0.796f, 0.435f, 0.098f, 1.0f },   // erTopSolidInfill: categorical 10 colortag
    { 0.910f, 0.529f, 0.102f, 1.0f },   // erIroning: erExternalPerimeter: categorical 3 colortag
    { 0.565f, 0.537f, 0.980f, 1.0f },   // erBridgeInfill: categorical 5 colortag
    { 0.980f, 0.980f, 0.980f, 1.0f },   // erGapFill: 98% near-white colortag
    { 0.318f, 0.267f, 0.827f, 1.0f },   // erSkirt: categorical 2 colortag
    { 0.098f, 0.753f, 0.780f, 1.0f },   // erSupportMaterial: categorical 1 colortag
    { 0.149f, 0.553f, 0.424f, 1.0f },   // erSupportMaterialInterface: categorical 11 colortag
    { 0.608f, 0.925f, 0.329f, 1.0f },   // erWipeTower: categorical 12 colortag
    { 0.278f, 0.886f, 0.435f, 1.0f },   // erCustom: categorical 6 colortag
    { 0.098f, 0.098f, 0.098f, 1.0f }    // erMixed: 9.8% near-black colortag
}};

const std::vector<GCodeViewer::Color> GCodeViewer::Options_Colors {{
    { 0.980f, 0.839f, 0.576f, 1.0f },   // Retractions: diverging o-y-s -1 colortag
    { 0.733f, 0.894f, 0.820f, 1.0f },   // Unretractions: diverging o-y-s +1 colortag
    { 0.875f, 0.749f, 0.098f, 1.0f },   // Seams: categorical 9 colortag
    { 0.941f, 0.941f, 0.941f, 1.0f },   // ToolChanges: 94.1% mono tint colortag
    { 0.753f, 0.753f, 0.753f, 1.0f },   // ColorChanges: 75.3% mono tint colortag
    { 0.631f, 0.631f, 0.631f, 1.0f },   // PausePrints: 63.1% mono tint colortag
    { 0.278f, 0.886f, 0.435f, 1.0f }    // CustomGCodes: categorical 6 colortag
}};

const std::vector<GCodeViewer::Color> GCodeViewer::Travel_Colors {{
    { 0.980f, 0.980f, 0.878f, 1.0f }, // Move: diverging o-y-s 0 colortag
    { 0.463f, 0.780f, 0.745f, 1.0f }, // Extrude: diverging o-y-s +2 colortag
    { 0.961f, 0.678f, 0.322f, 1.0f }  // Retract: diverging o-y-s -2 colortag
}};

#if 1
// Normal ranges sequential magma: https://spectrum.adobe.com/page/color-for-data-visualization/
const std::vector<GCodeViewer::Color> GCodeViewer::Range_Colors {{
    { 0.980f, 0.980f, 0.749f, 1.0f }, // sequential magma 1 colortag
    { 0.980f, 0.871f, 0.627f, 1.0f }, // sequential magma 2 colortag
    { 0.980f, 0.749f, 0.518f, 1.0f }, // sequential magma 3 colortag
    { 0.980f, 0.624f, 0.427f, 1.0f }, // sequential magma 4 colortag
    { 0.980f, 0.498f, 0.369f, 1.0f }, // sequential magma 5 colortag
    { 0.945f, 0.376f, 0.365f, 1.0f }, // sequential magma 6 colortag
    { 0.871f, 0.286f, 0.408f, 1.0f }, // sequential magma 7 colortag
    { 0.769f, 0.235f, 0.459f, 1.0f }, // sequential magma 8 colortag
    { 0.659f, 0.196f, 0.490f, 1.0f }, // sequential magma 9 colortag
    { 0.549f, 0.161f, 0.506f, 1.0f }, // sequential magma 10 colortag
    { 0.447f, 0.122f, 0.506f, 1.0f }  // sequential magma 11 colortag
}};
#else
// Detailed ranges
const std::vector<GCodeViewer::Color> GCodeViewer::Range_Colors{ {
...
const GCodeViewer::Color GCodeViewer::Wipe_Color = { 0.875f, 0.749f, 0.098f, 1.0f }; // categorical 9 colortag
const GCodeViewer::Color GCodeViewer::Neutral_Color = { 0.631f, 0.631f, 0.631f, 1.0f }; // 63.1% mono tint colortag
...
void GCodeViewer::refresh(const GCodeProcessorResult& gcode_result, const std::vector<std::string>& str_tool_colors)
{
    ...
    while (m_tool_colors.size() < std::max(size_t(1), gcode_result.extruders_count))
        m_tool_colors.push_back(decode_color("#E8871A")); // categorical 3 colortag
...
void GCodeViewer::refresh_render_paths(bool keep_sequential_current_first, bool keep_sequential_current_last) const
{
    ...
    auto extrusion_color = [this](const Path& path) {
        ...
        case EViewType::ColorPrint:     {
            if (path.cp_color_id >= static_cast<unsigned char>(m_tool_colors.size()))
                color = { 0.502f, 0.502f, 0.502f, 1.0f }; // 50.2% mono tone colortag
            else
                color = m_tool_colors[path.cp_color_id];

            break;
        }
        default: { color = { 0.980f, 0.980f, 0.980f, 1.0f }; break; } // 98% near-white colortag
        }
    ...
    for (const auto& [tbuffer_id, ibuffer_id, path_id, sub_path_id] : paths) {
        ...
        default: { color = { 0.098f, 0.098f, 0.098f, 1.0f }; break; } // 9.8% near-black colortag
        }
...
GCodeViewer::Color GCodeViewer::option_color(EMoveType move_type) const
{
    ...
    default:                      { return { 0.098f, 0.098f, 0.098f, 1.0f }; } // 9.8% near-black colortag
    }
}
