...
void Bed_2D::repaint(const std::vector<Vec2d>& shape)
{
	...
	// draw bed fill
	dc.SetBrush(wxBrush(wxColour(250, 250, 250), wxBRUSHSTYLE_SOLID)); // 98% white
	wxPointList pt_list;
    for (auto pt : shape)
    {
    ...
    dc.SetPen(wxPen(wxColour(240, 240, 240), 1, wxPENSTYLE_SOLID)); // 94% white
	...
	// draw bed contour
    dc.SetPen(wxPen(wxColour(25, 25, 25), 1, wxPENSTYLE_SOLID)); // 9.8% black
	dc.SetBrush(wxBrush(wxColour(25, 25, 25), wxBRUSHSTYLE_TRANSPARENT)); // 9.8% black
	dc.DrawPolygon(&pt_list, 0, 0);
    ...
    dc.SetPen(wxPen(wxColour(218, 52, 144), 2, wxPENSTYLE_SOLID));  // red // categorical 8
    ...
    dc.SetPen(wxPen(wxColour(71, 226, 111), 2, wxPENSTYLE_SOLID));  // green // categorical 12
	...
	// draw origin
    dc.SetPen(wxPen(wxColour(25, 25, 25), 1, wxPENSTYLE_SOLID)); // 9.8% black
    dc.SetBrush(wxBrush(wxColour(25, 25, 25), wxBRUSHSTYLE_SOLID)); // 9.8% black
	dc.DrawCircle(origin_px(0), origin_px(1), 3);

	static const auto origin_label = wxString("(0,0)");
	dc.SetTextForeground(wxColour(25, 25, 25)); // 9.8% black
	...
	if (m_pos!= Vec2d(0, 0)) {
        ...
        dc.SetPen(wxPen(wxColour(218, 52, 144), 2, wxPENSTYLE_SOLID)); // categorical 8
        dc.SetBrush(wxBrush(wxColour(218, 52, 144), wxBRUSHSTYLE_TRANSPARENT)); // categorical 8
