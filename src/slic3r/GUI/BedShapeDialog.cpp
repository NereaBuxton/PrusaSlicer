    ...
    line.widget = [this](wxWindow* parent) {
        ...
        filename_lbl->Bind(wxEVT_UPDATE_UI, ([this](wxUpdateUIEvent& e) {
                ...
                if (lbl != nullptr) {
                    ...
                    lbl->SetForegroundColour(exists ? /*wxSystemSettings::GetColour(wxSYS_COLOUR_WINDOWTEXT)*/wxGetApp().get_label_clr_default() : wxColour(218, 52, 144)); // categorical 4 colortag
