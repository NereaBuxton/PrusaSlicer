                ...
                wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER)
{
    ...
    m_html = new wxHtmlWindow(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHW_SCROLLBAR_AUTO/*NEVER*/);
    {
        ...
        const auto text = from_u8(
            ...
            "<font color=%3%>"
            "n8_precision_minus_plus_klipper modifications: <br />"
            "static constexpr double RESOLUTION = 0.001; <br />"
            "#define XYZF_NUM(val) PRECISION(val, 6) <br />"
            "#define E_NUM(val) PRECISION(val, 9) <br /><br />"
            "// Experimentally removed flow and spacing math for rounded edges. See <a href=\"https://manual.slic3r.org/advanced/flow-math\">Slic3r flow math</a>. <br /><br />"
            "Cherry-picked Klipper implementation from <a href=\"https://github.com/supermerill/SuperSlicer\">SuperSlicer</a> (PrusaSlicer fork, previously called Slic3r++ <br /><br />"
