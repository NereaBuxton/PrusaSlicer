...
void Tab::create_preset_tab()
{
    ...
    m_hsizer->Add(m_left_sizer, 0, wxEXPAND | wxLEFT | wxTOP | wxBOTTOM, 7);
...
void TabPrint::build()
{
    ...
    auto page = add_options_page(L("Layers and perimeters"), "layers");
        ...
        optgroup->append_single_option_line("loop_clipping_length");
        optgroup->append_single_option_line("external_perimeters_first", category_path + "external-perimeters-first");
        optgroup->append_single_option_line("optimize_island_extrusions");
        optgroup->append_single_option_line("little_move_inwards");
    ...
    page = add_options_page(L("Infill"), "infill");
        ...
        optgroup->append_single_option_line("solid_infill_adjust_spacing");
        optgroup->append_single_option_line("bridge_angle");
        optgroup->append_single_option_line("only_retract_when_crossing_perimeters");
        optgroup->append_single_option_line("infill_first");
        optgroup->append_single_option_line("infill_with_sheath");
    ...
    page = add_options_page(L("Speed"), "time");
        ...
        optgroup->append_single_option_line("small_perimeter_length");
...
void TabPrinter::build_fff()
{
    ...
    auto page = add_options_page(L("General"), "printer");
        ...
        optgroup->append_single_option_line("optimize_tool_order");
...
void TabPrinter::build_unregular_pages(bool from_initial_build/* = false*/)
{
    ...
    for (auto extruder_idx = m_extruders_count_old; extruder_idx < m_extruders_count; ++extruder_idx) {
        ...
        m_pages.insert(m_pages.begin() + n_before_extruders + extruder_idx, page);
            ...
            optgroup->append_single_option_line("retract_wipe_speed", "", extruder_idx);
...
void Page::activate(ConfigOptionMode mode, std::function<void()> throw_if_canceled)
{
    for (auto group : m_optgroups) {
        if (!group->activate(throw_if_canceled))
            continue;
        m_vsizer->Add(group->sizer, 0, wxEXPAND | (group->is_legend_line() ? (wxLEFT|wxTOP) : wxLEFT|wxRIGHT|wxBOTTOM), 10);
