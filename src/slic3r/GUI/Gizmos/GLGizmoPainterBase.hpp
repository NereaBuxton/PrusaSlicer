...
protected:
    ...
    virtual std::array<float, 4> get_cursor_sphere_left_button_color() const { return { 0.318f, 0.267f, 0.827f, 0.251f }; } // categorical 2, 25.1% alpha colortag
    virtual std::array<float, 4> get_cursor_sphere_right_button_color() const { return { 0.855f, 0.204f, 0.565f, 0.251f }; } // categorical 4, 25.1% alpha colortag
