...
void GLGizmoPainterBase::render_cursor_circle() const
{
    ...
    static const std::array<float, 3> color = {0.608f, 0.925f, 0.329f}; // categorical 12 colortag
...
void GLGizmoPainterBase::render_cursor_sphere(const Transform3d& trafo) const
{
    ...
    std::array<float, 4> render_color = { 0.098f, 0.098f, 0.098f, 0.251f}; // 9.8% near-black, 25.1% alpha colortag
...
{
    static constexpr std::array<float, 4> enforcers_color{ 0.565f, 0.537f, 0.980f, 1.0f }; // categorical 5 colortag
    static constexpr std::array<float, 4> blockers_color{ 0.855f, 0.204f, 0.565f, 1.0f };  // categorical 4 colortag
