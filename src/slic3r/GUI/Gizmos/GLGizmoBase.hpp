...
static const std::array<float, 4> DEFAULT_BASE_COLOR = { 0.631f, 0.631f, 0.631f, 1.0f }; // 63% white
static const std::array<float, 4> DEFAULT_DRAG_COLOR = { 0.980f, 0.980f, 0.980f, 1.0f }; // 98% white
static const std::array<float, 4> DEFAULT_HIGHLIGHT_COLOR = { 0.796f, 0.435f, 0.063f, 1.0f }; // categorical 6
...
static const std::array<float, 4> CONSTRAINED_COLOR = { 0.502f, 0.502f, 0.502f, 1.0f }; // 50% neutral
