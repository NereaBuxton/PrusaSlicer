...
void ConfigManipulation::toggle_print_fff_options(DynamicPrintConfig* config)
{
    ...
    for (auto el : { "extra_perimeters", "ensure_vertical_shell_thickness", "thin_walls", "overhangs",
                    ...
                    "perimeter_speed", "small_perimeter_speed", "small_perimeter_length", "external_perimeter_speed" })
    ...
    for (auto el : { "perimeter_acceleration", "infill_acceleration",
                    "solid_infill_acceleration", "support_material_acceleration",
    ...
    for (auto el : { "support_material_style", "support_material_pattern", "support_material_with_sheath",
                    ...
                    "support_material_xy_spacing", "support_material_expand_or_filter", "retract_skip_support_islands" })
    ...
    for (auto el : { "support_material_interface_spacing", "support_material_interface_extruder",
                    "support_material_interface_speed", "support_material_interface_contact_loops", "support_material_additional_xy_spacing", "support_material_interface_with_sheath" })
