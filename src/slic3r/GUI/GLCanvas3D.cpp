...
static constexpr const float DARKMODE_BG_DARK_COLOR[3] = { 0.098f, 0.098f, 0.098f }; // 9.8% near-black colortag
static constexpr const float DARKMODE_BG_MED_COLOR[3] = { 0.251f, 0.251f, 0.251f }; // 25.1% mono shade colortag
static constexpr const float DARKMODE_BG_LIGHT_COLOR[3] = { 0.753f, 0.753f, 0.753f }; // 75.3% mono tint colortag
static constexpr const float LIGHTMODE_BG_DARK_COLOR[3] = { 0.753f, 0.753f, 0.753f }; // 75.3% mono tint colortag
static constexpr const float LIGHTMODE_BG_MED_COLOR[3] = { 0.941f, 0.941f, 0.941f }; // 94.1% mono tint colortag
static constexpr const float LIGHTMODE_BG_LIGHT_COLOR[3] = { 0.980f, 0.980f, 0.980f }; // 98% near-white colortag
static constexpr const float ERROR_BG_DARK_COLOR[3] = { 0.980f, 0.749f, 0.518f }; // sequential magma 3 colortag
static constexpr const float ERROR_BG_MED_COLOR[3] = { 0.980f, 0.498f, 0.369f }; // sequential magma 5 colortag
static constexpr const float ERROR_BG_LIGHT_COLOR[3] = { 0.871f, 0.286f, 0.408f }; // sequential magma 7 colortag
...
void GLCanvas3D::LayersEditing::render_profile(const Rect& bar_rect) const
{
    ...
    // Baseline
    glsafe(::glColor3f(0.098f, 0.098f, 0.098f)); // 9.8% near-black colortag
    ...
    // Curve
    glsafe(::glColor3f(0.318f, 0.267f, 0.827f)); // categorical 2 colortag
    ::glBegin(GL_LINE_STRIP);
...
void GLCanvas3D::Labels::render(const std::vector<const ModelInstance*>& sorted_instances) const
{
    ...
    for (const Owner& owner : owners) {
        ...
        ImGui::PushStyleColor(ImGuiCol_Border, owner.selected ? ImVec4(0.796f, 0.435f, 0.098f, 1.0f) : ImVec4(0.753f, 0.753f, 0.753f, 1.0f)); // categorical 10 : 75.3% mono tint colortag
...
void GLCanvas3D::SequentialPrintClearance::set_polygons(const Polygons& polygons)
{
    ...
    if (m_render_fill) {
        ...
        entity.color = { 0.855f, 0.204f, 0.565f, 0.502f }; // categorical 4, 50.2% alpha colortag
...
{
    std::array<float, 4> FILL_COLOR = { 0.855f, 0.204f, 0.565f, 0.502f }; // categorical 4, 50.2% alpha colortag
    std::array<float, 4> NO_FILL_COLOR = { 0.980f, 0.980f, 0.980f, 0.753f }; // 98% near-white, 75.3% alpha colortag
...
void GLCanvas3D::render()
{
    ...
    camera.apply_projection(_max_bounding_box(false, true));
...
bool GLCanvas3D::_init_main_toolbar()
{
    ...
    arrow_data.filename = "toolbar_arrow_sharp.svg";
    arrow_data.left = 0;
    arrow_data.top = 0;
    arrow_data.right = 0;
    arrow_data.bottom = 0;
...
//    m_main_toolbar.set_layout_type(GLToolbar::Layout::Vertical);
    ...
    item.name = "more";
    item.icon_filename = "instance_add_solid_1.svg";
    ...
    item.name = "fewer";
    item.icon_filename = "instance_remove_solid_1.svg";
    ...
    item.name = "settings";
    item.icon_filename = "settings_solid_2.svg";
    ...
    item.name = "search";
    item.icon_filename = "search_solid_1.svg";
...
//    m_undoredo_toolbar.set_layout_type(GLToolbar::Layout::Vertical);
    ...
    item.name = "undo";
    item.icon_filename = "undo_toolbar_solid_1.svg";
    ...
    item.name = "redo";
    item.icon_filename = "redo_toolbar_solid_1.svg";
...
void GLCanvas3D::_load_print_toolpaths(const BuildVolume &build_volume)
{
    ...
    const std::array<float, 4> color = { 0.608f, 0.925f, 0.329f, 1.0f }; // categorical 12 colortag
...
void GLCanvas3D::_load_print_object_toolpaths(const PrintObject& print_object, const BuildVolume& build_volume, const std::vector<std::string>& str_tool_colors, const std::vector<CustomGCode::Item>& color_print_values)
{
    ...
    struct Ctxt
    {
        ...
        static const std::array<float, 4>& color_perimeters() { static std::array<float, 4> color = { 0.875f, 0.749f, 0.098f, 1.0f }; return color; } // categorical 9 colortag
        static const std::array<float, 4>& color_infill() { static std::array<float, 4> color = { 0.855f, 0.204f, 0.565f, 1.0f }; return color; } // categorical 4 colortag
        static const std::array<float, 4>& color_support() { static std::array<float, 4> color = { 0.608f, 0.925f, 0.329f, 1.0f }; return color; } // categorical 12 colortag
        static const std::array<float, 4>& color_pause_or_custom_code() { static std::array<float, 4> color = { 0.502f, 0.502f, 0.502f, 1.0f }; return color; } // 50.2% mono tone colortag
