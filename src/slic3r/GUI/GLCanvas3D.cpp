...
void GLCanvas3D::Labels::render(const std::vector<const ModelInstance*>& sorted_instances) const
{
    ...
    for (const Owner& owner : owners) {
        ...
        ImGui::PushStyleColor(ImGuiCol_Border, owner.selected ? ImVec4(0.796f, 0.435f, 0.063f, 1.0f) : ImVec4(0.749f, 0.749f, 0.749f, 1.0f)); // categorical 6 : 75% white
...
void GLCanvas3D::SequentialPrintClearance::set_polygons(const Polygons& polygons)
{
    ...
    if (m_render_fill) {
        ...
        entity.color = { 0.855f, 0.204f, 0.565f, 0.5f }; // categorical 8 50% alpha
