...
{
// ~~ https://github.com/aschn/gnuplot-colorbrewer ~~ now using: diverging orange-yellow-seafoam https://spectrum.adobe.com/page/color-for-data-visualization/
    std::vector<Vec3crd> palette_raw;
    palette_raw.push_back(Vec3crd(0x0BD, 0x065, 0x01A)); // -
    palette_raw.push_back(Vec3crd(0x0DD, 0x086, 0x029));
    palette_raw.push_back(Vec3crd(0x0F5, 0x0AD, 0x052));
    palette_raw.push_back(Vec3crd(0x0FA, 0x0D6, 0x093));
    palette_raw.push_back(Vec3crd(0x0FA, 0x0FA, 0x0E0)); // 0
    palette_raw.push_back(Vec3crd(0x0BB, 0x0E4, 0x0D1));
    palette_raw.push_back(Vec3crd(0x076, 0x0C7, 0x0BE));
    palette_raw.push_back(Vec3crd(0x03E, 0x0A8, 0x0A6));
    palette_raw.push_back(Vec3crd(0x020, 0x082, 0x088)); // +
