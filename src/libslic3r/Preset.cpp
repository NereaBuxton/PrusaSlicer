...
static std::vector<std::string> s_Preset_print_options {
    ...
    "top_solid_infill_speed", "support_material_speed", "support_material_xy_spacing", "support_material_additional_xy_spacing", "support_material_expand_or_filter", "support_material_interface_speed", "skirt_speed",
    "bridge_speed", "gap_fill_speed", "gap_fill_enabled", "travel_speed", "travel_speed_z", "first_layer_speed", "first_layer_speed_over_raft", "perimeter_acceleration", "solid_infill_acceleration", "infill_acceleration", "support_material_acceleration",
    "support_material_interface_acceleration","bridge_acceleration", "first_layer_acceleration", "first_layer_acceleration_over_raft", "default_acceleration", "skirts", "skirt_distance", "skirt_extra_loops", "skirt_extra_loop_layers", "skirt_height", "draft_shield",
...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "use_firmware_retraction", "use_volumetric_e", "variable_layer_height", "reverse_tool_order",
