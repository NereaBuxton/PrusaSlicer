...
static std::vector<std::string> s_Preset_print_options {
    ...
    "top_solid_infill_speed", "support_material_speed", "support_material_xy_spacing", "support_material_additional_xy_spacing", "support_material_minimum_width", "support_material_interface_speed", "skirt_speed",
