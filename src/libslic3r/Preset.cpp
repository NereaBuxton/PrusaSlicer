...
static std::vector<std::string> s_Preset_print_options {
    ...
    "solid_infill_adjust_spacing", "solid_infill_acceleration", "support_material_acceleration", "support_material_interface_acceleration", "small_perimeter_length",
    "skirt_extra_loops", "skirt_extra_loop_layers", "skirt_speed", "optimize_island_extrusions", "little_move_inwards", "loop_clipping_length",
...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "use_firmware_retraction", "use_volumetric_e", "variable_layer_height", "optimize_tool_order",
