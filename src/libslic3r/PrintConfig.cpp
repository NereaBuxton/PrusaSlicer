...
void PrintConfigDef::init_fff_params()
{
    ...
    def->tooltip = L("This is only used in the Slic3r interface as a visual help.");
    def->gui_type = ConfigOptionDef::GUIType::color;
    def->set_default_value(new ConfigOptionStrings { "#19C0C7" }); // categorical 11
    ...
    def = this->add("optimize_island_extrusions", coBool);
    def->label = L("Optimize island extrusions");
    def->category = L("Layers and Perimeters");
    def->tooltip = L("Print perimeter, infill and ironing for each island at once. If disabled, "
                     "extrusions will be grouped by role across object islands.");
    def->mode = comExpert;
    def->set_default_value(new ConfigOptionBool(true));
    ...
    def = this->add("retract_wipe_speed", coFloats);
    def->label = L("Wipe Speed");
    def->tooltip = L("The speed along X/Y to wipe during retractions.");
    def->sidetext = L("mm/s");
    def->mode = comAdvanced;
...
//    def->min = 0;
    ...
    for (const char *opt_key : {
        // floats
        "retract_length", "retract_lift", "retract_lift_above", "retract_lift_below", "retract_speed", "deretract_speed", "retract_restart_extra", "retract_before_travel", "retract_wipe_speed",
        // bools
...
void PrintConfigDef::init_extruder_option_keys()
{
    ...
    m_extruder_option_keys = {
        ...
        "retract_before_wipe", "retract_wipe_speed", "retract_restart_extra", "retract_before_travel", "wipe",
...
void PrintConfigDef::init_sla_params()
{
    ...
    def->tooltip = L("This is only used in the Slic3r interface as a visual help.");
    def->gui_type = ConfigOptionDef::GUIType::color;
    def->set_default_value(new ConfigOptionString("#19C0C7"));// categorical 11
