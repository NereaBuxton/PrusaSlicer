...
#define GCODEVIEWER_APP_NAME "PrusaSlicer-n8 G-code Viewer"
#define GCODEVIEWER_APP_KEY  "PrusaSlicerN8GcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("PrusaSlicer-n8 G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-UNKNOWN")
