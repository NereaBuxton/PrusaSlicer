...
{
	return std::string("generated by PrusaSlicer " SLIC3R_VERSION "-n8 on " ) + Utils::utc_timestamp();
}

std::string header_gcodeviewer_generated()
{
	return std::string("generated by " GCODEVIEWER_APP_NAME " " SLIC3R_VERSION "-n8 on ") + Utils::utc_timestamp();
}
