...
//#endif
    ...
    ((ConfigOptionBool,                optimize_tool_order))
...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    ((ConfigOptionInt,                skirt_extra_loops))
    ((ConfigOptionInt,                skirt_extra_loop_layers))
    ...
    ((ConfigOptionFloat,              support_material_acceleration))
    ((ConfigOptionFloat,              support_material_interface_acceleration))
